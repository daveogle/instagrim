...
<html>
    ...
    <body>
        ...
        <nav>
            ...
            <ul>
                <li><a href="/Instagrim-dao"> Home </a></li>
                <li><a href ="/Instagrim-dao/Comments/<%=user%>">Show Comments</a></li>
        ...
        <div class="picture">
            <a id="<%=p.getSUUID()%>" onclick="deletePic('<%=p.getSUUID()%>', '<%=user%>');"><img alt="Instagrim User Image" src="/Instagrim-dao/Thumb/<%=p.getSUUID()%>"></a><br/>
        </div>
